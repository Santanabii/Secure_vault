...
class AddEditWindow:
    def __init__(self, parent, encryption, db_handler, refresh_callback, entry_to_edit=None):
    ...
    def setup_ui(self):
        ...
        # Site
        ctk.CTkLabel(self.window, text="Website / Application Name *").pack(anchor="w", padx=50, pady=(10,2))
        ...
        ctk.CTkButton(self.window, text=btn_text, height=50, 
    ...
    def pre_fill_data(self):
        ...
        self.notes_entry.insert("1.0", self.entry_to_edit.get("notes", ""))
    ...
    def save_password(self):
        ...
        try:
            ...
            if self.entry_to_edit:
                self.db.update_password(self.entry_to_edit["_id"], data)
